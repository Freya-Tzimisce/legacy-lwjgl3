...
public class KeyCodes {
    ...
    public static int glfwToLwjgl(int glfwKeyCode) {
        ...
        return switch (glfwKeyCode) {
            ...
            case GLFW.GLFW_KEY_WORLD_1 -> Keyboard.KEY_CIRCUMFLEX; // "World" keys could be anything depending on keyboard layout, pick something arbitrary
    ...
    public static int lwjglToGlfw(int lwjglKeyCode) {
        ...
        return switch (lwjglKeyCode) {
            ...
            case Keyboard.KEY_CIRCUMFLEX -> GLFW.GLFW_KEY_WORLD_1; // "World" keys could be anything depending on keyboard layout, pick something arbitrary
